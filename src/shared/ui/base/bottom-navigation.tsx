...
const BottomNavigation = () => {
  return (
    <aside className="fixed bottom-0 left-0 w-full px-1 py-3 border-t border-t-primary/50 bg-muted/95 rounded-t-xl shadow-2xl shadow-primary backdrop-blur-sm z-50">
